  ...
  return <section className="py-20 bg-gradient-card">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {achievements.map((achievement, index) => <Card key={index} className="shadow-card border-0 hover:shadow-executive transition-all duration-300">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white p-8 rounded-lg shadow-card">
            ...
            <div className="space-y-3">
              {credentials.map((credential, index) => <Badge key={index} variant="secondary" className="block text-left p-3 bg-gray-light text-navy-deep hover:bg-gold-light transition-colors">
                  {credential}
                </Badge>)}
            </div>
          </div>
